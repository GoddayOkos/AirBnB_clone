...
class TestPlace(unittest.TestCase):
    ...
    def test_basic_attribute_set(self):
        ...
        """
        self.P.first_name = 'Godday'
        self.P.last_name = 'Okoduwa'
        self.assertEqual(self.P.first_name, 'Godday')
        self.assertEqual(self.P.last_name, 'Okoduwa')
    ...
    def test_from_dict_hard(self):
        ...
        my_dict = self.P.to_dict()
        self.assertEqual(my_dict['name'], 'Godday')
        P1 = self.P.__class__(**my_dict)
        self.assertEqual(P1.created_at, self.P.created_at)
